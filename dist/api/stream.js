...
const simulator_1 = require("../src/sim/simulator");
/**
...
async function handler(req, res) {
    ...
    try {
        ...
        const supabaseClient = new supabase_1.SupabaseDatabaseClient(supabaseUrl, serviceRoleKey);
 ...
 */
async function initializeSimulator(cachedClient) {
    try {
        ...
        globalSimulator = new simulator_1.Simulator(initialState);
 ...
 */
function startSimulation(cachedClient) {
    if (simulationInterval) {
    ...
    simulationInterval = setInterval(async () => {
        ...
        try {
            ...
            cache_1.cacheManager.setLatestTick(tickData);
 ...
 */
function formatTickForStream(tickResult) {
    return {
